...
class ElelanJobs(JobChannelMethods):
    job_channel_id = "wzQvbeLW59Q0EOTKnw76"

    # returns true if the message is a "product post" type post, false other wise
    def is_post_job(self, message: str):
        return "Open positions".lower() in message.lower() or "Deadline".lower() in message.lower()
